                ...
                <div className="rounded-lg border bg-background p-8">
                    ...
                    */}
                    <p className="mb-4 leading-normal text-muted-foreground">
                        <span className="font-semibold text-foreground">ChatMonnet is an experimental conversational agent created by JEF Galicia and JEF Bordeaux to emulate the persona of Jean Monnet.</span> It is based on the GPT-3.5 model, which is a transformer-based language model that was trained on a large amount of text from the internet. The model was trained by the OpenAI team and is available through their API.
                    </p>
                    ...
                    <ul className="list-disc list-inside mb-4 leading-normal text-muted-foreground">
                        <li>A conditioning instruction that makes the system behave as Jean Monnet.</li>
                        <li>Background information about Jean Monnet. This includes a short biography, a list of his works, and a list of his quotes.</li>
                        <li>Information about the creators of ChatMonnet and JEF.</li>
