        ...
        <div className="flex min-h-[calc(100vh-theme(spacing.16))] items-center justify-center py-10 flex-col gap-8">
            <div className="mx-auto max-w-2xl px-4">
                <div className="rounded-lg border bg-background p-8">
                    ...
                    <p className="mb-4 leading-normal text-muted-foreground">
                        <span className="font-semibold text-foreground">We&apos;ve built ChatMonnet to help you understand your digital rights.</span> You can ask him about how the EU protects your rights, what they are, and how you can use them.
                    </p>
                    <Link className="mt-4 flex flex-col items-start space-y-2" href="/?initialMessage=What%20is%20the%20EU%20doing%20to%20protect%20my%20digital%20rights%3F">
                        ...
                        >
                            ...
                            Ask ChatMonnet about your digital rights
                        </Button>
                    </Link>
